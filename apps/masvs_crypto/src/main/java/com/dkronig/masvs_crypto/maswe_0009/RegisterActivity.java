package com.dkronig.masvs_crypto.maswe_0009;
...
/**
 * Register Activity for MASWE-0009
 *
 * Features:
 *  - Uses a custom encryption handler for decrypting user passwords.
 */
public class RegisterActivity extends BaseRegisterActivity {
    private static final String CREDENTIALS_FILE_NAME = "maswe_0009_user_credentials";
