package com.dkronig.masvs_crypto.maswe_0012;
...
/**
 * Main Activity of MASWE-0012
 *
 * Features:
 *  - Generates a new encryption key if none exists yet. Used for encryption and decryption in
 *  - login and register activity.
 *  - Buttons to navigate to both Register and Login Activity of MASWE-0012.
 */
public class MainActivity0012 extends BaseActivityTemplate {
    private static final String SCREEN_TITLE = "MASWE_0012";
