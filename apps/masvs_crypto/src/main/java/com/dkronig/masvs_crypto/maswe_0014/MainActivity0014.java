...
/**
 * Main Activity of MASWE-0014
 *
 * Features:
 *  - Generates a new encryption key if none exists yet. Used for encryption and decryption in
 *  - login and register activity.
 *  - Buttons to navigate to both Register and Login Activity of MASWE-0014.
 */
public class MainActivity0014 extends BaseActivityTemplate {
    private static final String SCREEN_TITLE = "MASWE_0014";
