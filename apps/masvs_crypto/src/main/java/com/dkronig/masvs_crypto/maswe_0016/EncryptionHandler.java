package com.dkronig.masvs_crypto.maswe_0016;
...
public class EncryptionHandler {
    ...
    /**
     * Checks if there is a public key already stored in shared storage.
     * If a key is found in MediaStore, it is imported and used.
     * Creates and stored a public key in shared storage otherwise.
     *
     * @return The either imported or generated public key
     * @throws Exception If import or generating of key fails
     */
    private PublicKey getImportedOrCreatePublicKey() throws Exception {
        Uri existingPublicKeyLocation = getPublicKeyUri();
        if (existingPublicKeyLocation != null) {
            return importKey(existingPublicKeyLocation);
        }
