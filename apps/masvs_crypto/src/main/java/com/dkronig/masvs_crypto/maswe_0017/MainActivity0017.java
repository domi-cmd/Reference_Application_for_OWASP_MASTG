package com.dkronig.masvs_crypto.maswe_0017;
...
/**
 * Main Activity of MASWE-0017
 *
 * Features:
 *  - Generates a new encryption key if none exists yet. Used for encryption and decryption in
 *  - login and register activity.
 *  - Buttons to navigate to both Register and Login Activity of MASWE-0017.
 */
public class MainActivity0017 extends BaseActivityTemplate {
    private static final String SCREEN_TITLE = "MASWE_0017";
