...
4. There are many documented oracle attacks that have happened, so this is a very real threat.

## Interesting links and sources:
- [Deep dive into oracle attacks](https://www.brunorochamoura.com/posts/cbc-padding-oracle/)
- [Article on types of oracle attacks](https://www.packetlabs.net/posts/what-are-oracle-attacks/)
