...
The relevant code for this vulnerability can be seen in [maswe_0027/EncryptionHandler.java](https://github.com/domi-cmd/Reference_Application_for_OWASP_MASTG/blob/main/apps/maswe_crypto/src/main/java/com/dkronig/maswe_crypto/maswe_0027/EncryptionHandler.java).
