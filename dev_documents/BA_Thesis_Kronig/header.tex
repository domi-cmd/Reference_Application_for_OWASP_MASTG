...
% Custom Paket für saubere verweise
...
% Code Box
\definecolor{CodeKeywords}{rgb}{0.5,0,0.5}
...
% Zeilenabstand
\renewcommand{\baselinestretch}{1.2} % -> document.tex -> \tableofcontents
...
% Define additional colors for Java syntax
\definecolor{CodeTypes}{rgb}{0,0.4,0.6}
\definecolor{CodeAnnotations}{rgb}{0.6,0.6,0}
...
\lstdefinestyle{JavaStyle}{
  language=Java,
  keywordstyle=\color{CodeKeywords}\bfseries,
  keywordstyle=[2]\color{CodeTypes}\bfseries,
  keywordstyle=[3]\color{CodeAnnotations},
  morekeywords=[2]{String,Integer,Boolean,Long,Double,Float,Character,Byte,Short,void,int,long,double,float,char,byte,short,boolean,Context,KeyStore,InputStream,Exception},
  morekeywords=[3]{@Override,@Deprecated,@SuppressWarnings,@FunctionalInterface,@SafeVarargs}
}
...
\lstdefinestyle{XMLStyle}{
  ...
  commentstyle=\color{CodeComments}\itshape,
  stringstyle=\color{CodeStrings},
  identifierstyle=\color{CodeTypes},
  morestring=[b]",
  morestring=[s]{>}{<},
  morecomment=[s]{<?}{?>},
  morecomment=[s]{<!--}{-->},
  moredelim=[s][\color{CodeTypes}]{<}{\ },
  moredelim=[s][\color{CodeTypes}]{</}{>},
  moredelim=[l][\color{CodeTypes}]{/>},
  moredelim=[l][\color{CodeTypes}]{>}
}
...
\lstdefinestyle{TerminalStyle}{
  ...
  morekeywords={adb, run-as, cat, ls, cd, pwd, chmod, su, exit, echo, grep, shell},
  showstringspaces=false,
  breaklines=true,
  breakatwhitespace=true,
  columns=flexible,
...
% Pseudo Code
% \begin{lstlisting}[float=tbh, mathescape=true, captionpos=b, caption=foo, label=bar, language=pseudo]
